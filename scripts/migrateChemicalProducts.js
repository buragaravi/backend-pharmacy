...
const connectDB = async () => {
  try {
    const conn = await mongoose.connect('mongodb+srv://ravi:RaPy2025@ravipydah.wnmy712.mongodb.net/StocksPharmacy?retryWrites=true&w=majority' || 'mongodb://localhost:27017/jits-db');
